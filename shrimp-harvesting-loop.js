...
class ShrimpHarvestingLoop extends BaseLoop {
   ...
   * @param {Object} [options.harvestCoords={ x: 5, y: 2 }] - Coordinates for fishing.
   ...
   * @example
   * node shrimp-harvesting-loop.js [characterName] [harvestX] [harvestY] [bankX] [bankY]
   * node shrimp-harvesting-loop.js MyChar 5 2 4 1
   */
  static async main() {
    ...
    const loop = new ShrimpHarvestingLoop(characterName, options);

    console.log(`Starting shrimp fishing loop for character ${characterName}...`);
