...
class GudgeonHarvestingLoop extends BaseLoop {
   ...
   * @param {Object} [options.harvestCoords={ x: 4, y: 2 }] - Coordinates for fishing.
...
if (require.main === module) {
  ...
  const loop = new GudgeonHarvestingLoop(characterName, options);

  console.log(`Starting gudgeon fishing loop for character ${characterName}...`);
